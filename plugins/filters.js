...
const array = ['Hi','King','love','alive','love','Bgm','Hlo','Love','Pali','Sad','Song','Neymar','Messi','SFI','Ringtone','paatt','Bot','Allu','Vijay','Bai','Power','Sed','Venda','Manyan','gdnight','Goodmorning','Loveu','Polikkum','Save','Chunk','Va','Kali','Da','Umbi','3g','Avalu','Palkuppi','Gun','Go','Nialle','Ooo','Kannapi','Mood','Africa','Fan','Poda','Life','Cr7','Ronaldo','song','help']
array.map( async (a) => {
